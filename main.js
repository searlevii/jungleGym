...
// // pseuedo code--- hopefuly works
// // let  showTrainerTeamx5 = document.getElemnetById('what ever the Id for specific group is');
//
// function thisWillShowthePokemon (){
//       if (showTrainerTeam.style.display == none){
//         showTrainerTeam.style.display = inline-block;
//       }else (showTrainerTeam.style.display == inline-block;){
//         showTrainerTeam.style.display = none;
//       }
// }
//
// thisWillShowthePokemon.addEventListner( 'click', showTrainerTeam );
